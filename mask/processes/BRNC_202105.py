...
def createMarkers(lib):
    ...
    marker_left = gdspy.CellReference(field.cell, origin=(-40500, 0))
    markers.add(marker_left)

    marker_right = gdspy.CellReference(field.cell, origin=(+40500, 0), x_reflection=True, rotation=180)
...
def createWaferAlignment(lib):
    ...
    outline = Ring(layer, outline_cell, RADIUS - 3000, RADIUS + 3000, flat=35000)
